...
internal static class IncrementalGeneratorInitializationContextExtensions
{
    public static void AddDirectoriesSetupAttribute(this IncrementalGeneratorInitializationContext context) =>
        context.RegisterPostInitializationOutput(static postInitializationContext =>
            postInitializationContext.AddSource(
                $"Attributes_{Constants.Attributes.DirectoriesSetup.Name}Attribute.generated.cs",
                SourceText.From(
                    $$"""
                      // <auto-generated/>
    ...
    public static void AddCollectionDefinitionAttribute(this IncrementalGeneratorInitializationContext context) =>
        context.RegisterPostInitializationOutput(static postInitializationContext =>
            postInitializationContext.AddSource(
                $"Attributes_{Constants.Attributes.CollectionDefinition.Name}Attribute.generated.cs",
                SourceText.From(
                    $$"""
                      // <auto-generated/>
                      ...
                      public enum {{Constants.Enums.StorageType.Name}}
                      {
                          {{Constants.Enums.StorageType.Values.Local}},
                          
                          [RequiresPreviewFeatures]
                          {{Constants.Enums.StorageType.Values.AzureBlob}},
                          [RequiresPreviewFeatures]
                          {{Constants.Enums.StorageType.Values.AwsS3}}
                      }
                      ...
                      #nullable disable
                          ...
                          public {{Constants.Enums.StorageType.Name}} {{Constants.Attributes.CollectionDefinition.Members.StorageType}} { get; set; }
                      #nullable enable
                      }
                      """,
                    Encoding.UTF8)));

    public static void AddCollectionExtensionAttribute(this IncrementalGeneratorInitializationContext context) =>
        context.RegisterPostInitializationOutput(static postInitializationContext =>
            postInitializationContext.AddSource(
                $"Attributes_{Constants.Attributes.CollectionExtension.Name}Attribute.generated.cs",
                SourceText.From(
                    $$"""
                      // <auto-generated/>
                      namespace {{Constants.RazorStaticAttributesNamespace}};
                      ...
                      [System.AttributeUsage(System.AttributeTargets.Assembly, AllowMultiple = true, Inherited = false)]
                      public sealed class {{Constants.Attributes.CollectionExtension.Name}}Attribute : System.Attribute
                      {
                      #nullable disable
                          public string {{Constants.Attributes.CollectionExtension.Members.Key}} { get; set; }
                          
                          public string {{Constants.Attributes.CollectionExtension.Members.PageRoute}} { get; set; }
                          
                          public string {{Constants.Attributes.CollectionExtension.Members.GroupBy}} { get; set; }
                      #nullable enable
                      }
                      """,
                    Encoding.UTF8)));
    ...
    public static void AddStaticContentAttribute(this IncrementalGeneratorInitializationContext context) =>
        context.RegisterPostInitializationOutput(static postInitializationContext =>
            postInitializationContext.AddSource(
                $"Attributes_{Constants.Attributes.StaticContent.Name}Attribute.generated.cs",
                SourceText.From(
                    $$"""
                      // <auto-generated/>
                      namespace {{Constants.RazorStaticAttributesNamespace}};
